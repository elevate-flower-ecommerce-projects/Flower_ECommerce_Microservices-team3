...
namespace Address___Store_Coverage_Service.Persistence.Repositories
{
    public class GenericRepository<T> : IGenericRepository<T> where T : BaseEntity
    {
        protected readonly FlowersAddressStoreCoverageDbContext _context;
        protected readonly DbSet<T> _dbSet;
        public GenericRepository(FlowersAddressStoreCoverageDbContext context)
        {
            _context = context;
